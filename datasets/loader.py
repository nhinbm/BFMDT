...
def load_yale_data(data_dir="datasets/data/yale/", n_components=1024):
    """
...
def load_pems_sf_data(data_dir="datasets/data/pems-sf/"):
    ...
    if n_samples != 440 or n_features != 138672:
        print(f"[Loader] [WARNING] PEMS-SF dimensions do not match the paper! (Expected: 440x138672, Current: {n_samples}x{n_features})")
